...
public class UserDaoTest {
	...
	public void testShouldCreateUserAccount() {
		...
		given(session.save(expectedUser)).willReturn(users.add(expectedUser));
		// when
		boolean actualResult = userDao.createUserAccount(expectedUser);
		// then
	...
	public void testShouldGetAllUsers() {
		...
		when(session.createQuery("SELECT u FROM User u", User.class)).thenReturn(query);
